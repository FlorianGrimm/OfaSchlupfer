namespace OfaSchlupfer.ODataV3 {
    ...
    public static class Edm3Utilities {
        public static bool IsDefaultEntityContainer(this IEdmModel model, IEdmEntityContainer entityContainer) {
            ...
            var obj = Microsoft.Data.Edm.ExtensionMethods.GetAnnotationValue(model, entityContainer, Edm3Constants.DataServicesNamespace, Edm3Constants.IsDefaultEntityContainerAttributeName);
