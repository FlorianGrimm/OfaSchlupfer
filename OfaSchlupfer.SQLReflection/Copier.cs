namespace OfaSchlupfer.SQLReflection {
    ...
    public class Copier : ScriptDom.TSqlConcreteFragmentVisitor {
        ...
        ScriptDom.TSqlFragment sqlFragment;
        ...
        public override void ExplicitVisit(ScriptDom.AlterFunctionStatement node) { }
        ...
        public override void ExplicitVisit(ScriptDom.AlterProcedureStatement node) { }
         ...
         * public override void ExplicitVisit(ScriptDom.NullLiteral node) {
            base.ExplicitVisit(node);
        }
        public override void ExplicitVisit(ScriptDom.BeginTransactionStatement node) {
            base.ExplicitVisit(node);
        }
        public override void ExplicitVisit(ScriptDom.BinaryExpression node) {
            base.ExplicitVisit(node);
        }
        public override void ExplicitVisit(ScriptDom.BeginEndAtomicBlockStatement node) {
            base.ExplicitVisit(node);
        }
        public override void ExplicitVisit(ScriptDom.BeginEndBlockStatement node) {
            base.ExplicitVisit(node);
        }
        */
    }
