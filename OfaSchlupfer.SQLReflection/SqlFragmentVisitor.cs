namespace OfaSchlupfer.SQLReflection {
    public abstract class SqlFragmentVisitor {
        ...
        internal bool VisitBaseType { get { return this._visitBaseType; } }

        protected SqlFragmentVisitor()
        : this(true) { }

        internal SqlFragmentVisitor(bool visitBaseType) { this._visitBaseType = visitBaseType; }
        public virtual void Start<T>(T node) where T : SqlNode { }

        public virtual void Done<T>(T node) where T : SqlNode { }
