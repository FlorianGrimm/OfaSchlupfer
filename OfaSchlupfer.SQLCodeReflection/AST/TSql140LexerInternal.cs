...
namespace OfaSchlupfer.AST {
    ...
    internal class TSql140LexerInternal : TSqlLexerBaseInternal, TokenStream {
        ...
        public static readonly BitSet tokenSet_0_ = new BitSet(TSql140LexerInternal.mk_tokenSet_0_());

        public static readonly BitSet tokenSet_1_ = new BitSet(TSql140LexerInternal.mk_tokenSet_1_());

        public static readonly BitSet tokenSet_2_ = new BitSet(TSql140LexerInternal.mk_tokenSet_2_());

        public static readonly BitSet tokenSet_3_ = new BitSet(TSql140LexerInternal.mk_tokenSet_3_());

        public static readonly BitSet tokenSet_4_ = new BitSet(TSql140LexerInternal.mk_tokenSet_4_());

        public static readonly BitSet tokenSet_5_ = new BitSet(TSql140LexerInternal.mk_tokenSet_5_());

        public static readonly BitSet tokenSet_6_ = new BitSet(TSql140LexerInternal.mk_tokenSet_6_());

        public static readonly BitSet tokenSet_7_ = new BitSet(TSql140LexerInternal.mk_tokenSet_7_());

        public static readonly BitSet tokenSet_8_ = new BitSet(TSql140LexerInternal.mk_tokenSet_8_());

        public static readonly BitSet tokenSet_9_ = new BitSet(TSql140LexerInternal.mk_tokenSet_9_());

        public static readonly BitSet tokenSet_10_ = new BitSet(TSql140LexerInternal.mk_tokenSet_10_());

        public static readonly BitSet tokenSet_11_ = new BitSet(TSql140LexerInternal.mk_tokenSet_11_());

        public static readonly BitSet tokenSet_12_ = new BitSet(TSql140LexerInternal.mk_tokenSet_12_());

        public static readonly BitSet tokenSet_13_ = new BitSet(TSql140LexerInternal.mk_tokenSet_13_());

        public TSql140LexerInternal()
        ...
        private void initialize() {
            ...
            base.literals.Add("semanticsimilaritydetailstable", 186);
            ...
            base.literals.Add("stoplist", 183);
            ...
            base.literals.Add("try_convert", 187);
            ...
            base.literals.Add("semanticsimilaritytable", 185);
            base.literals.Add("unpivot", 178);
            ...
            base.literals.Add("semantickeyphrasetable", 184);
        ...
        public override IToken nextToken() {
            while (true) {
                ...
                this.resetText();
                try {
                    char cached_LA = base.cached_LA1;
                    if (cached_LA <= '\u1680') {
                        switch (cached_LA) {
                            case '!':
                                break;
                    ...
                    if (base.cached_LA1 == '-') {
                        this.mMinus(true);
                        IToken returnToken_34 = base.returnToken_;
                        goto IL_072a;
                    }
                    if (base.cached_LA1 == '/') {
                        this.mDivide(true);
                        IToken returnToken_35 = base.returnToken_;
                        goto IL_072a;
                    }
                    if (base.cached_LA1 == ':') {
                        this.mColon(true);
                        IToken returnToken_36 = base.returnToken_;
                        goto IL_072a;
                    }
                    if (base.cached_LA1 == '=') {
                        this.mEqualsSign(true);
                        IToken returnToken_37 = base.returnToken_;
                        goto IL_072a;
                    }
                    if (base.cached_LA1 == '^') {
                        this.mCircumflex(true);
                        IToken returnToken_38 = base.returnToken_;
                        goto IL_072a;
                    }
                    if (base.cached_LA1 == '|') {
                        this.mVerticalLine(true);
                        IToken returnToken_39 = base.returnToken_;
                        goto IL_072a;
                    }
                    if (TSql140LexerInternal.tokenSet_0_.member(base.cached_LA1)) {
                        this.mIdentifier(true);
                        IToken returnToken_40 = base.returnToken_;
                        goto IL_072a;
                    }
        ...
        protected void mFirstLetter(bool _createToken) {
            ...
            switch (base.cached_LA1) {
                ...
                case '#':
                    ...
                    break;
                default:
                    if (TSql140LexerInternal.tokenSet_1_.member(base.cached_LA1)) {
        ...
        protected void mCharHighNotWhitespace(bool _createToken) {
            ...
            switch (base.cached_LA1) {
                ...
                case '⁞':
                    ...
                    break;
                default:
                    if (base.cached_LA1 >= '¡' && base.cached_LA1 <= 'ᙹ') {
                        this.matchRange('¡', 'ᙹ');
                        break;
                    }
                    if (base.cached_LA1 >= 'ᚁ' && base.cached_LA1 <= '\u1fff') {
                        this.matchRange('ᚁ', '\u1fff');
                        break;
                    }
        ...
        public void mProcNameSemicolon(bool _createToken) {
            ...
            if (base.cached_LA1 == ';') {
                ...
                try {
                    ...
                    while (true) {
                        if (!TSql140LexerInternal.tokenSet_2_.member(base.cached_LA1)) {
                            break;
                        }
        ...
        public void mGo(bool _createToken) {
            ...
            this.match("go");
            while (true) {
                if (TSql140LexerInternal.tokenSet_3_.member(base.cached_LA1)) {
                    this.mLetter(false);
                    if (base.inputState.guessing == 0) {
                        ttype = 232;
                    }
        ...
        public void mAsciiStringLiteral(bool _createToken) {
            ...
            while (true) {
                if (base.cached_LA1 == '\'' && base.cached_LA2 == '\'') {
                    this.match('\'');
                    this.match('\'');
                } else if (TSql140LexerInternal.tokenSet_4_.member(base.cached_LA1)) {
                    if (base.inputState.guessing == 0) {
                        base.checkEOF(TokenKind.String);
                    }
                    this.match(TSql140LexerInternal.tokenSet_4_);
                } else {
                    if (base.cached_LA1 != '\n' && base.cached_LA1 != '\r') {
                        break;
                    }
        ...
        public void mIdentifier(bool _createToken) {
            ...
            if (flag) {
                ...
                int num = 0;
                while (true) {
                    if (TSql140LexerInternal.tokenSet_5_.member(base.cached_LA1)) {
                        if (base.inputState.guessing == 0) {
                            base.checkEOF(TokenKind.SqlCommandIdentifier);
                        }
                        this.match(TSql140LexerInternal.tokenSet_5_);
                    } else {
                        if (base.cached_LA1 != '\n' && base.cached_LA1 != '\r') {
                            break;
                        }
            ...
            bool flag2 = false;
            if (base.cached_LA1 == '$' && TSql140LexerInternal.tokenSet_6_.member(base.cached_LA2)) {
                int pos2 = this.mark();
                flag2 = true;
                base.inputState.guessing++;
                try {
                    ...
                    if (TSql140LexerInternal.tokenSet_7_.member(base.cached_LA1)) {
            ...
            bool flag3 = false;
            if (TSql140LexerInternal.tokenSet_8_.member(base.cached_LA1) && TSql140LexerInternal.tokenSet_9_.member(base.cached_LA2)) {
                int pos3 = this.mark();
                flag3 = true;
                base.inputState.guessing++;
                try {
                ...
                case '[': {
                        ...
                        while (true) {
                            if (base.cached_LA1 == ']' && base.cached_LA2 == ']') {
                                this.match(']');
                                this.match(']');
                            } else if (TSql140LexerInternal.tokenSet_10_.member(base.cached_LA1)) {
                                if (base.inputState.guessing == 0) {
                                    base.checkEOF(TokenKind.QuotedIdentifier);
                                }
                                this.match(TSql140LexerInternal.tokenSet_10_);
                            } else {
                                if (base.cached_LA1 != '\n' && base.cached_LA1 != '\r') {
                                    break;
                                }
                ...
                case '"':
                    ...
                    while (true) {
                        if (base.cached_LA1 == '"' && base.cached_LA2 == '"') {
                            this.match('"');
                            this.match('"');
                        } else if (TSql140LexerInternal.tokenSet_11_.member(base.cached_LA1)) {
                            if (base.inputState.guessing == 0) {
                                base.checkEOF(TokenKind.QuotedIdentifier);
                            }
                            this.match(TSql140LexerInternal.tokenSet_11_);
                        } else {
                            if (base.cached_LA1 != '\n' && base.cached_LA1 != '\r') {
                                break;
                            }
        ...
        public void mSingleLineComment(bool _createToken) {
            ...
            if (flag) {
                ...
                while (true) {
                    if (!TSql140LexerInternal.tokenSet_12_.member(base.cached_LA1)) {
                        break;
                    }
                    if (this.LA(1) == CharScanner.EOF_CHAR) {
                        break;
                    }
                    this.match(TSql140LexerInternal.tokenSet_12_);
                }
                if (base.inputState.guessing == 0) {
                    base._acceptableGoOffset = base.CurrentOffset;
                }
        ...
        public void mMultilineComment(bool _createToken) {
            ...
            while (true) {
                if (base.cached_LA1 == '*' && base.cached_LA2 >= '\0' && base.cached_LA2 <= '\uffff' && this.LA(2) != '/') {
                    ...
                    if (!TSql140LexerInternal.tokenSet_13_.member(base.cached_LA1)) {
                        break;
                    }
                    if (base.inputState.guessing == 0) {
                        base.checkEOF(TokenKind.MultiLineComment);
                    }
                    this.match(TSql140LexerInternal.tokenSet_13_);
                }
            }
            this.match("*/");
            if (base.inputState.guessing == 0 && flag) {
