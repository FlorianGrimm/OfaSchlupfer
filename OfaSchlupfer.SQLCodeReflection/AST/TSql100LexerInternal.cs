...
namespace OfaSchlupfer.AST {
    ...
    internal class TSql100LexerInternal : TSqlLexerBaseInternal, TokenStream {
                ...
                try {
                    switch (base.cached_LA1) {
                        ...
                        default:
                            ...
                            if (TSql100LexerInternal.tokenSet_0_.member(base.cached_LA1)) {
        ...
        public void mProcNameSemicolon(bool _createToken) {
            ...
            if (base.cached_LA1 == ';') {
                ...
                try {
                    ...
                    while (true) {
                        if (!TSql100LexerInternal.tokenSet_1_.member(base.cached_LA1)) {
                            break;
                        }
        ...
        public void mGo(bool _createToken) {
            ...
            this.match("go");
            while (true) {
                if (TSql100LexerInternal.tokenSet_2_.member(base.cached_LA1)) {
                    this.mLetter(false);
                    if (base.inputState.guessing == 0) {
                        ttype = 232;
                    }
        ...
        public void mAsciiStringLiteral(bool _createToken) {
            ...
            while (true) {
                if (base.cached_LA1 == '\'' && base.cached_LA2 == '\'') {
                    this.match('\'');
                    this.match('\'');
                } else if (TSql100LexerInternal.tokenSet_3_.member(base.cached_LA1)) {
                    if (base.inputState.guessing == 0) {
        ...
        public void mIdentifier(bool _createToken) {
            ...
            if (flag) {
                ...
                int num = 0;
                while (true) {
                    if (TSql100LexerInternal.tokenSet_4_.member(base.cached_LA1)) {
                        if (base.inputState.guessing == 0) {
            ...
            bool flag2 = false;
            if (base.cached_LA1 == '$' && TSql100LexerInternal.tokenSet_5_.member(base.cached_LA2)) {
                int pos2 = this.mark();
                flag2 = true;
                base.inputState.guessing++;
                try {
                    ...
                    if (TSql100LexerInternal.tokenSet_6_.member(base.cached_LA1)) {
            ...
            bool flag3 = false;
            if (TSql100LexerInternal.tokenSet_7_.member(base.cached_LA1) && TSql100LexerInternal.tokenSet_8_.member(base.cached_LA2)) {
                int pos3 = this.mark();
                flag3 = true;
                base.inputState.guessing++;
                try {
                ...
                case '[': {
                        ...
                        while (true) {
                            if (base.cached_LA1 == ']' && base.cached_LA2 == ']') {
                                this.match(']');
                                this.match(']');
                            } else if (TSql100LexerInternal.tokenSet_9_.member(base.cached_LA1)) {
                                if (base.inputState.guessing == 0) {
                ...
                case '"':
                    ...
                    while (true) {
                        if (base.cached_LA1 == '"' && base.cached_LA2 == '"') {
                            this.match('"');
                            this.match('"');
                        } else if (TSql100LexerInternal.tokenSet_10_.member(base.cached_LA1)) {
                            if (base.inputState.guessing == 0) {
                                base.checkEOF(TokenKind.QuotedIdentifier);
                            }
        ...
        public void mSingleLineComment(bool _createToken) {
            ...
            if (flag) {
                ...
                while (true) {
                    if (!TSql100LexerInternal.tokenSet_11_.member(base.cached_LA1)) {
                        break;
                    }
        ...
        public void mMultilineComment(bool _createToken) {
            ...
            while (true) {
                if (base.cached_LA1 == '*' && base.cached_LA2 >= '\0' && base.cached_LA2 <= '\uffff' && this.LA(2) != '/') {
                    ...
                    if (!TSql100LexerInternal.tokenSet_12_.member(base.cached_LA1)) {
                        break;
                    }
                    if (base.inputState.guessing == 0) {
