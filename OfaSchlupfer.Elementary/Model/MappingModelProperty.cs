namespace OfaSchlupfer.Model {
    ...
    public class MappingModelProperty
        ...
        public override void ResolveNameSource(ModelErrors errors) {
            this.ResolveNameSourceHelper(this.Owner, (owner, name) => owner.Source.Properties.FindByKey(name), errors);
        }

        public override void ResolveNameTarget(ModelErrors errors) {
            this.ResolveNameSourceHelper(this.Owner, (owner, name) => owner.Target.Properties.FindByKey(name), errors);
        }
    }
}