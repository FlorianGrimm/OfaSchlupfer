namespace OfaSchlupfer.MSSQLReflection.Model.SqlSys {
    ...
    public sealed class SqlSysDatabase : EntityArrayProp {
        ...
        public SqlSysDatabase() : this(new MetaEntityArrayProp(), new object[0]) {
        }

        public SqlSysDatabase(MetaEntityArrayProp metaData, object[] values) : base(metaData, values) {
        ...
        /// </summary>
        /// <param name="sqlTransConnection"></param>
