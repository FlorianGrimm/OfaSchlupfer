namespace OfaSchlupfer.ScriptDom {
    public abstract class TSqlConcreteFragmentVisitor : TSqlFragmentVisitor {
        ...
        public sealed override void Visit(SecurityPolicyStatement node) {
            base.Visit(node);
        }

        public sealed override void ExplicitVisit(SecurityPolicyStatement node) {
            base.ExplicitVisit(node);
        }

        public sealed override void Visit(ColumnMasterKeyParameter node) {
            base.Visit(node);
        }

        public sealed override void ExplicitVisit(ColumnMasterKeyParameter node) {
            base.ExplicitVisit(node);
        }

        public sealed override void Visit(ColumnEncryptionKeyStatement node) {
            base.Visit(node);
        }

        public sealed override void ExplicitVisit(ColumnEncryptionKeyStatement node) {
            base.ExplicitVisit(node);
        }

        public sealed override void Visit(ColumnEncryptionKeyValueParameter node) {
            base.Visit(node);
        }

        public sealed override void ExplicitVisit(ColumnEncryptionKeyValueParameter node) {
            base.ExplicitVisit(node);
        }

        public sealed override void Visit(ExternalTableStatement node) {
            base.Visit(node);
        }

        public sealed override void ExplicitVisit(ExternalTableStatement node) {
            base.ExplicitVisit(node);
        }

        public sealed override void Visit(ExternalTableOption node) {
            base.Visit(node);
        }

        public sealed override void ExplicitVisit(ExternalTableOption node) {
            base.ExplicitVisit(node);
        }

        public sealed override void Visit(ExternalTableDistributionPolicy node) {
            base.Visit(node);
        }

        public sealed override void ExplicitVisit(ExternalTableDistributionPolicy node) {
            base.ExplicitVisit(node);
        }

        public sealed override void Visit(ExternalDataSourceStatement node) {
            base.Visit(node);
        }

        public sealed override void ExplicitVisit(ExternalDataSourceStatement node) {
            base.ExplicitVisit(node);
        }

        public sealed override void Visit(ExternalDataSourceOption node) {
            base.Visit(node);
        }

        public sealed override void ExplicitVisit(ExternalDataSourceOption node) {
            base.ExplicitVisit(node);
        }

        public sealed override void Visit(ExternalFileFormatStatement node) {
            base.Visit(node);
        }

        public sealed override void ExplicitVisit(ExternalFileFormatStatement node) {
            base.ExplicitVisit(node);
        }

        public sealed override void Visit(ExternalFileFormatOption node) {
            base.Visit(node);
        }

        public sealed override void ExplicitVisit(ExternalFileFormatOption node) {
            base.ExplicitVisit(node);
        }
        ...
        public sealed override void Visit(RemoteDataArchiveDatabaseSetting node) {
            base.Visit(node);
        }

        public sealed override void ExplicitVisit(RemoteDataArchiveDatabaseSetting node) {
            base.ExplicitVisit(node);
        }
        ...
        public sealed override void Visit(AlterDatabaseScopedConfigurationStatement node) {
            base.Visit(node);
        }

        public sealed override void ExplicitVisit(AlterDatabaseScopedConfigurationStatement node) {
            base.ExplicitVisit(node);
        }
        ...
        public sealed override void Visit(QueryStoreOption node) {
            base.Visit(node);
        }

        public sealed override void ExplicitVisit(QueryStoreOption node) {
            base.ExplicitVisit(node);
        }

        public sealed override void Visit(ColumnEncryptionDefinitionParameter node) {
            base.Visit(node);
        }

        public sealed override void ExplicitVisit(ColumnEncryptionDefinitionParameter node) {
            base.ExplicitVisit(node);
        }
        ...
        public sealed override void Visit(TableDistributionPolicy node) {
            base.Visit(node);
        }

        public sealed override void ExplicitVisit(TableDistributionPolicy node) {
            base.ExplicitVisit(node);
        }
        ...
        public sealed override void Visit(PartitionSpecifications node) {
            base.Visit(node);
        }

        public sealed override void ExplicitVisit(PartitionSpecifications node) {
            base.ExplicitVisit(node);
        }
