...
namespace OfaSchlupfer.ScriptDom {
    ...
    internal class TSql130LexerInternal : TSqlLexerBaseInternal, TokenStream {
        ...
        public static readonly BitSet tokenSet_0_ = new BitSet(TSql130LexerInternal.mk_tokenSet_0_());

        public static readonly BitSet tokenSet_1_ = new BitSet(TSql130LexerInternal.mk_tokenSet_1_());

        public static readonly BitSet tokenSet_2_ = new BitSet(TSql130LexerInternal.mk_tokenSet_2_());

        public static readonly BitSet tokenSet_3_ = new BitSet(TSql130LexerInternal.mk_tokenSet_3_());

        public static readonly BitSet tokenSet_4_ = new BitSet(TSql130LexerInternal.mk_tokenSet_4_());

        public static readonly BitSet tokenSet_5_ = new BitSet(TSql130LexerInternal.mk_tokenSet_5_());

        public static readonly BitSet tokenSet_6_ = new BitSet(TSql130LexerInternal.mk_tokenSet_6_());

        public static readonly BitSet tokenSet_7_ = new BitSet(TSql130LexerInternal.mk_tokenSet_7_());

        public static readonly BitSet tokenSet_8_ = new BitSet(TSql130LexerInternal.mk_tokenSet_8_());

        public static readonly BitSet tokenSet_9_ = new BitSet(TSql130LexerInternal.mk_tokenSet_9_());

        public static readonly BitSet tokenSet_10_ = new BitSet(TSql130LexerInternal.mk_tokenSet_10_());

        public static readonly BitSet tokenSet_11_ = new BitSet(TSql130LexerInternal.mk_tokenSet_11_());

        public static readonly BitSet tokenSet_12_ = new BitSet(TSql130LexerInternal.mk_tokenSet_12_());

        public static readonly BitSet tokenSet_13_ = new BitSet(TSql130LexerInternal.mk_tokenSet_13_());

        public TSql130LexerInternal()
        ...
        public override IToken nextToken() {
            while (true) {
                ...
                try {
                    ...
                    if (TSql130LexerInternal.tokenSet_0_.member(base.cached_LA1)) {
        ...
        protected void mFirstLetter(bool _createToken) {
            ...
            switch (base.cached_LA1) {
                ...
                case '#':
                    ...
                    break;
                default:
                    if (TSql130LexerInternal.tokenSet_1_.member(base.cached_LA1)) {
        ...
        public void mProcNameSemicolon(bool _createToken) {
            ...
            if (base.cached_LA1 == ';') {
                ...
                try {
                    ...
                    while (true) {
                        if (!TSql130LexerInternal.tokenSet_2_.member(base.cached_LA1)) {
                            break;
                        }
        ...
        public void mGo(bool _createToken) {
            ...
            this.match("go");
            while (true) {
                if (TSql130LexerInternal.tokenSet_3_.member(base.cached_LA1)) {
                    this.mLetter(false);
                    if (base.inputState.guessing == 0) {
                        ttype = 232;
                    }
        ...
        public void mAsciiStringLiteral(bool _createToken) {
            ...
            while (true) {
                if (base.cached_LA1 == '\'' && base.cached_LA2 == '\'') {
                    this.match('\'');
                    this.match('\'');
                } else if (TSql130LexerInternal.tokenSet_4_.member(base.cached_LA1)) {
                    if (base.inputState.guessing == 0) {
                        base.checkEOF(TokenKind.String);
                    }
                    this.match(TSql130LexerInternal.tokenSet_4_);
                } else {
                    if (base.cached_LA1 != '\n' && base.cached_LA1 != '\r') {
                        break;
                    }
        ...
        public void mIdentifier(bool _createToken) {
            ...
            if (flag) {
                ...
                int num = 0;
                while (true) {
                    if (TSql130LexerInternal.tokenSet_5_.member(base.cached_LA1)) {
                        if (base.inputState.guessing == 0) {
                            base.checkEOF(TokenKind.SqlCommandIdentifier);
                        }
                        this.match(TSql130LexerInternal.tokenSet_5_);
                    } else {
                        if (base.cached_LA1 != '\n' && base.cached_LA1 != '\r') {
                            break;
                        }
            ...
            bool flag2 = false;
            if (base.cached_LA1 == '$' && TSql130LexerInternal.tokenSet_6_.member(base.cached_LA2)) {
                int pos2 = this.mark();
                flag2 = true;
                base.inputState.guessing++;
                try {
                    ...
                    if (TSql130LexerInternal.tokenSet_7_.member(base.cached_LA1)) {
            ...
            bool flag3 = false;
            if (TSql130LexerInternal.tokenSet_8_.member(base.cached_LA1) && TSql130LexerInternal.tokenSet_9_.member(base.cached_LA2)) {
                int pos3 = this.mark();
                flag3 = true;
                base.inputState.guessing++;
                try {
                ...
                case '[': {
                        ...
                        while (true) {
                            if (base.cached_LA1 == ']' && base.cached_LA2 == ']') {
                                this.match(']');
                                this.match(']');
                            } else if (TSql130LexerInternal.tokenSet_10_.member(base.cached_LA1)) {
                                if (base.inputState.guessing == 0) {
                                    base.checkEOF(TokenKind.QuotedIdentifier);
                                }
                                this.match(TSql130LexerInternal.tokenSet_10_);
                            } else {
                                if (base.cached_LA1 != '\n' && base.cached_LA1 != '\r') {
                                    break;
                                }
                ...
                case '"':
                    ...
                    while (true) {
                        if (base.cached_LA1 == '"' && base.cached_LA2 == '"') {
                            this.match('"');
                            this.match('"');
                        } else if (TSql130LexerInternal.tokenSet_11_.member(base.cached_LA1)) {
                            if (base.inputState.guessing == 0) {
                                base.checkEOF(TokenKind.QuotedIdentifier);
                            }
                            this.match(TSql130LexerInternal.tokenSet_11_);
                        } else {
                            if (base.cached_LA1 != '\n' && base.cached_LA1 != '\r') {
                                break;
                            }
        ...
        public void mSingleLineComment(bool _createToken) {
            ...
            if (flag) {
                ...
                while (true) {
                    if (!TSql130LexerInternal.tokenSet_12_.member(base.cached_LA1)) {
                        break;
                    }
                    if (this.LA(1) == CharScanner.EOF_CHAR) {
                        break;
                    }
                    this.match(TSql130LexerInternal.tokenSet_12_);
                }
                if (base.inputState.guessing == 0) {
                    base._acceptableGoOffset = base.CurrentOffset;
                }
        ...
        public void mMultilineComment(bool _createToken) {
            ...
            while (true) {
                if (base.cached_LA1 == '*' && base.cached_LA2 >= '\0' && base.cached_LA2 <= '\uffff' && this.LA(2) != '/') {
                    ...
                    if (!TSql130LexerInternal.tokenSet_13_.member(base.cached_LA1)) {
                        break;
                    }
                    if (base.inputState.guessing == 0) {
                        base.checkEOF(TokenKind.MultiLineComment);
                    }
                    this.match(TSql130LexerInternal.tokenSet_13_);
                }
            }
            this.match("*/");
            if (base.inputState.guessing == 0 && flag) {
